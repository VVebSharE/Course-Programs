...
{   
    ...
    for(int i=1;i<=n;i++)
    {
        printf("Enter sex-code of student %d :",i);fflush(stdin);
        scanf("%c",&sex_code);
        for( ;sex_code!='F' && sex_code!='M'; )
        {
            printf("\nEnter valid sex-code('M'/'F') of student %d :",i);fflush(stdin);
            scanf("%c",&sex_code);
        }
    ...
    printf("\n");
    printf("Average female height in class : %.1f cm",af);
    printf("\n");
    printf("Average male height in class : %.1f cm",am);
